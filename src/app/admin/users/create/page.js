// src/app/admin/users/page.jsx (or [id]/page.jsx if using dynamic routing)
"use client";
...
const UserPage = () => {
  ...
  const publicId = searchParams.get("id"); // ?id=<publicId>
  const type = searchParams.get("type") || "USER"; // ?type=USER or ADMIN
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              {user
                ...
                : "Register a new user/admin to the platform"}
            </p>
          </div>
        </div>
      </div>
